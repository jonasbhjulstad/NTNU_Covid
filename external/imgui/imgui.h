...
struct ImGuiStyle
{
    ...
    float       CurveTessellationTol;       // Tessellation tolerance when using PathEdgeCurveTo() without a specific number of segments. Decrease for highly tessellated curves (higher quality, more polygons), increase to reduce quality.
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddEdgeCurve(const ImVec2& pos0, const ImVec2& cp0, const ImVec2& cp1, const ImVec2& pos1, ImU32 col, float thickness, int num_segments = 0);
    ...
    IMGUI_API void  PathEdgeCurveTo(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, int num_segments = 0);
