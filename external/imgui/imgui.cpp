...
ImGuiStyle::ImGuiStyle()
{
    ...
    CurveTessellationTol    = 1.25f;            // Tessellation tolerance when using PathEdgeCurveTo() without a specific number of segments. Decrease for highly tessellated curves (higher quality, more polygons), increase to reduce quality.
