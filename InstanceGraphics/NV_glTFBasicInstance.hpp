...
namespace glTFBasicInstance
{
    ...
    template <> VulkanBuffer prepareInstanceBuffer(std::vector<NodeInstanceData> &instanceData, VulkanDevice *vulkanDevice, VkQueue queue);
    template <> VulkanBuffer prepareInstanceBuffer(std::vector<EdgeInstanceData> &instanceData, VulkanDevice *vulkanDevice, VkQueue queue);
